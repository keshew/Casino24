...
class FishViewModel: ObservableObject {
    let contact = FishModel()
    @Published var slots: [[String]] = []
    @Published var coin =   UserDefaultsManager.shared.coins
    @Published var bet = 100
    let allFruits = ["fcg1", "fcg2", "fcg3","fcg4", "fcg5", "fcg6"]
    ...
    let symbolArray = [
        Symbol(image: "fcg1", value: "200"),
        Symbol(image: "fcg2", value: "200"),
        Symbol(image: "fcg3", value: "200"),
        Symbol(image: "fcg4", value: "100"),
        Symbol(image: "fcg5", value: "100"),
        Symbol(image: "fcg6", value: "100")
    ]
