                        ...
                        VStack(spacing: 30) {
                            ...
                            VStack(spacing: 0) {
                                Rectangle()
                                    ...
                                    .overlay {
                                        RoundedRectangle(cornerRadius: 12)
                                            .stroke(Color(red: 60/255, green: 212/255, blue: 255/255), lineWidth: 5)
                                            .overlay {
                                                VStack(spacing: 10) {
                                                    ForEach(0..<3, id: \.self) { row in
                                                        HStack(spacing: 10) {
                                                            ForEach(0..<4, id: \.self) { col in
                                                                Rectangle()
                                                                    .fill(Color(red: 211/255, green: 207/255, blue: 183/255))
                                                                    .frame(width: 60, height: 60)
                                                                    .overlay {
                                                                        RoundedRectangle(cornerRadius: 8)
                                                                            .stroke(Color(red: 60/255, green: 212/255, blue: 255/255), lineWidth: 3)
                                                                            .overlay {
                            ...
                            HStack(spacing: 20) {
                                Button(action: {
                                    ...
                                    Circle()
                                        .fill(Color(red: 60/255, green: 212/255, blue: 255/255))
                                        .overlay {
                                            RoundedRectangle(cornerRadius: 15)
                                                ...
                                                .overlay {
                                                    Text("-")
                                                        ...
                                                        .foregroundStyle(Color(red: 0/255, green: 68/255, blue: 83/255))
                                                        .offset(y: -3)
                                                }
                                        }
