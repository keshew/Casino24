...
class ZeusViewModel: ObservableObject {
    let contact = ZeusModel()
    @Published var slots: [[String]] = []
    @Published var coin =   UserDefaultsManager.shared.coins
    @Published var bet = 100
    let allFruits = ["zs1", "zs2", "zs3","zs4", "zs5", "zs6"]
    ...
    let symbolArray = [
        Symbol(image: "art1", value: "200"),
        Symbol(image: "art2", value: "200"),
        Symbol(image: "art3", value: "200"),
        Symbol(image: "art4", value: "100"),
        Symbol(image: "art5", value: "100"),
        Symbol(image: "art6", value: "100")
    ]
