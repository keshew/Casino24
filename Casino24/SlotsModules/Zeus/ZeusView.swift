...
struct ZeusView: View {
    @StateObject var viewModel =  ZeusViewModel()
                        ...
                        VStack(spacing: 30) {
                            ...
                            VStack(spacing: 0) {
                                ...
                                Rectangle()
                                    ...
                                    .overlay {
                                        RoundedRectangle(cornerRadius: 12)
                                            .stroke(Color(red: 3/255, green: 100/255, blue: 223/255), lineWidth: 5)
                                            .overlay {
                                                VStack(spacing: 10) {
                                                                ...
                                                                Rectangle()
                                                                    ...
                                                                    .overlay {
                                                                        RoundedRectangle(cornerRadius: 8)
                                                                            .stroke(Color(red: 97/255, green: 167/255, blue: 213/255), lineWidth: 3)
                                                                            .overlay {
