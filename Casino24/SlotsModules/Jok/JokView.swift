...
struct JokView: View {
    @StateObject var viewModel =  JokViewModel()
                        ...
                        VStack(spacing: 30) {
                            ...
                            VStack(spacing: 0) {
                                Rectangle()
                                    ...
                                    .overlay {
                                        RoundedRectangle(cornerRadius: 12)
                                            .stroke(Color(red: 255/255, green: 92/255, blue: 92/255), lineWidth: 5)
                                            .overlay {
                                                VStack(spacing: 10) {
                                                                ...
                                                                Rectangle()
                                                                    ...
                                                                    .overlay {
                                                                        RoundedRectangle(cornerRadius: 8)
                                                                            .stroke(Color(red: 63/255, green: 101/255, blue: 24/255), lineWidth: 3)
                                                                            .overlay {
                            ...
                            HStack(spacing: 20) {
                                Button(action: {
                                    if viewModel.bet >= 150 {
                                        viewModel.bet -= 50
                                    }
                                }) {
                                    Circle()
                                        .fill(Color(red: 255/255, green: 58/255, blue: 59/255))
                                        .overlay {
