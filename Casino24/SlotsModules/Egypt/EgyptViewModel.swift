...
class EgyptViewModel: ObservableObject {
    let contact = EgyptModel()
    ...
    let symbolArray = [
        Symbol(image: "eg1", value: "200"),
        Symbol(image: "eg2", value: "200"),
        Symbol(image: "eg3", value: "200"),
        Symbol(image: "eg4", value: "100"),
        Symbol(image: "eg5", value: "100"),
        Symbol(image: "eg6", value: "100")
    ]
